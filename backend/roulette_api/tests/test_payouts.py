...
# Assume necessary imports for the payout logic are available or mocked
...
class PayoutCalculationTest(TestCase):
    ...
    def test_straight_up_win(self):
        ...
        multiplier, won = self.calculate_payout('STRAIGHT_UP', '17', 17, 10)
    ...
    def test_straight_up_loss(self):
        ...
        multiplier, won = self.calculate_payout('STRAIGHT_UP', '17', 18, 10)
    ...
    def test_red_color_win(self):
        ...
        multiplier, won = self.calculate_payout('RED', 'RED', 3, 20)
